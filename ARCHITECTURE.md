...
- **Responsibilities:**
  ...
  - Validates yt-dlp video/audio templates by starting `yt-dlp -o <template> dummy:` with a managed environment, explicit start/finish timeouts, and process-tree cleanup on timeout.
