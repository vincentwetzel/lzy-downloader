...
- **Application Updates**: GitHub release checks must validate JSON object/array types before reading release notes or assets, skip malformed asset entries, and report a clear update-check failure if a newer release has no usable assets.
